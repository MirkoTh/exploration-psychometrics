...
# 
# ggplot(trueParams, aes(estimate)) + geom_histogram(alpha = 0.5, position = "identity") + facet_wrap(vars(predictor), scale= "free")
# 

################# Sam's task ########

## UCB
res_list1 <- recovery_sam(sam, "UCB", hierarchical = T)
