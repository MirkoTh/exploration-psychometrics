...
var trial_type_updating = [
    ['update', 'immediate', 'update', 'update', 'update', 'update', 'update', 'update', 'update', 'update', 'immediate', 'update', 'update', 'update', 'immediate', 'update', 'immediate', 'update', 'immediate', 'update', 'update', 'update', 'immediate', 'update', 'update', 'update', 'update'],
    ['update', 'immediate', 'update', 'update', 'update', 'immediate', 'immediate', 'immediate', 'immediate', 'update', 'update', 'update', 'update', 'update', 'update', 'immediate', 'update', 'update', 'update', 'update', 'update', 'update', 'update', 'update', 'update', 'update', 'update']
]

var immediate_set_updating = [
    [[3, 9, 1, 0], [7, 1, 0, 5], [1, 5, 7, 2], [3, 6, 1, 4], [7, 3, 6, 1], [2, 3, 0, 7]],
    [[7, 4, 8, 0], [5, 3, 9, 1], [4, 6, 2, 1], [0, 9, 2, 1], [4, 2, 3, 6], [5, 0, 4, 2]]

]


var initial_set_updating = [
    [[0, 2, 8, 7], [4, 6, 3, 5], [8, 6, 3, 9], [1, 2, 0, 3], [6, 3, 4, 0], [6, 3, 2, 0], [0, 4, 1, 2], [6, 5, 4, 1], [6, 3, 8, 4], [9, 4, 7, 1], [4, 3, 8, 6], [5, 8, 1, 4], [4, 1, 9, 8], [8, 2, 7, 1], [7, 6, 5, 0], [2, 6, 3, 7], [9, 5, 8, 1], [2, 9, 8, 7], [1, 3, 7, 0], [9, 6, 5, 8], [0, 8, 2, 4]],
    [[7, 9, 6, 2], [0, 8, 3, 9], [7, 9, 3, 5], [8, 9, 5, 0], [0, 5, 9, 6], [9, 2, 4, 0], [6, 7, 8, 5], [6, 8, 4, 9], [6, 5, 7, 2], [0, 4, 6, 9], [3, 5, 0, 9], [1, 7, 8, 5], [2, 9, 8, 3], [9, 4, 8, 3], [4, 2, 5, 9], [7, 8, 3, 5], [0, 9, 7, 4], [2, 9, 3, 0], [1, 6, 0, 5], [3, 8, 6, 5], [0, 7, 3, 5]]

]


var locations_update_updating = [
    [[3, 3, 2, 1, 3, 2, 3], [0, 1, 0, 2, 3, 2, 3], [3, 2, 2, 1, 0, 2, 0], [3, 3, 1, 3, 2, 1, 3], [2, 0, 1, 2, 3, 0, 2], [2, 0, 1, 1, 1, 3, 0], [2, 3, 1, 0, 0, 2, 2], [0, 1, 1, 1, 2, 1, 2], [0, 3, 1, 3, 3, 2, 0], [3, 1, 2, 3, 0, 0, 2], [3, 1, 3, 2, 0, 0, 1], [3, 3, 1, 2, 3, 3, 0], [3, 2, 2, 2, 1, 2, 1], [1, 3, 1, 2, 1, 0, 1], [2, 3, 0, 0, 1, 2, 1], [3, 3, 0, 1, 0, 2, 2], [0, 3, 2, 3, 0, 0, 0], [0, 3, 0, 3, 1, 3, 1], [1, 2, 3, 2, 3, 0, 3], [3, 2, 1, 2, 3, 1, 3], [1, 2, 3, 3, 3, 2, 0]],
    [[2, 1, 0, 1, 0, 1, 2], [2, 0, 1, 3, 0, 1, 2], [0, 3, 0, 2, 1, 1, 2], [2, 1, 3, 1, 1, 0, 0], [2, 3, 0, 2, 1, 0, 1], [3, 0, 2, 2, 2, 2, 0], [0, 2, 1, 2, 1, 2, 2], [1, 1, 0, 0, 2, 1, 0], [2, 3, 2, 0, 0, 3, 0], [1, 1, 0, 0, 1, 2, 3], [2, 2, 2, 2, 1, 3, 3], [3, 0, 1, 3, 1, 1, 2], [3, 0, 2, 0, 3, 2, 1], [0, 1, 0, 2, 0, 3, 3], [0, 2, 1, 0, 1, 1, 2], [1, 3, 3, 2, 3, 0, 0], [2, 3, 2, 0, 0, 3, 2], [2, 1, 2, 1, 0, 3, 0], [2, 1, 2, 2, 1, 2, 3], [1, 0, 3, 0, 3, 3, 1], [1, 3, 3, 1, 1, 2, 1]]
]


var items_replace_updating = [
    [[6, 8, 6, 8, 0, 1, 1], [8, 9, 3, 9, 4, 3, 3], [6, 5, 4, 4, 1, 1, 3], [0, 9, 9, 1, 6, 7, 8], [2, 0, 1, 6, 1, 3, 4], [6, 2, 2, 0, 8, 6, 0], [1, 9, 5, 4, 2, 6, 1], [3, 9, 8, 0, 4, 9, 2], [8, 6, 8, 3, 9, 7, 0], [2, 5, 3, 5, 2, 3, 5], [0, 5, 8, 8, 8, 5, 6], [6, 7, 9, 5, 8, 1, 4], [0, 7, 0, 5, 1, 7, 9], [7, 3, 6, 2, 3, 3, 5], [2, 4, 9, 2, 4, 0, 8], [2, 3, 9, 3, 5, 4, 4], [4, 4, 9, 4, 9, 0, 6], [9, 8, 4, 4, 4, 7, 8], [2, 2, 4, 5, 4, 4, 7], [9, 7, 1, 3, 2, 3, 0], [5, 2, 6, 7, 7, 2, 6]],
    [[0, 1, 5, 5, 5, 6, 3], [2, 5, 6, 0, 1, 0, 1], [8, 9, 0, 5, 7, 8, 0], [8, 9, 9, 1, 5, 4, 0], [1, 6, 7, 3, 9, 3, 1], [5, 4, 8, 9, 4, 1, 3], [6, 8, 9, 3, 0, 1, 4], [9, 8, 3, 4, 8, 5, 4], [0, 8, 5, 5, 8, 0, 0], [4, 3, 9, 6, 8, 2, 8], [0, 9, 5, 2, 3, 6, 5], [4, 1, 9, 5, 5, 3, 4], [0, 0, 2, 0, 4, 7, 3], [7, 9, 4, 2, 4, 2, 9], [8, 7, 5, 8, 5, 8, 1], [2, 5, 7, 5, 2, 2, 1], [0, 2, 8, 4, 6, 3, 9], [1, 4, 3, 6, 0, 0, 9], [9, 2, 2, 2, 5, 0, 0], [5, 9, 8, 5, 8, 7, 8], [8, 8, 5, 5, 3, 8, 2]]
]

var final_set_updating = [
    [[0, 8, 1, 1], [3, 9, 3, 3], [3, 4, 1, 6], [1, 7, 6, 8], [3, 1, 4, 1], [0, 8, 6, 6], [2, 5, 1, 9], [3, 9, 2, 1], [0, 8, 7, 9], [3, 5, 5, 5], [5, 6, 8, 8], [4, 9, 5, 1], [4, 9, 7, 0], [3, 5, 2, 3], [2, 8, 0, 4], [5, 3, 4, 3], [6, 5, 9, 4], [4, 8, 8, 7], [4, 2, 5, 7], [9, 3, 3, 0], [6, 5, 2, 7]],
    [[5, 6, 3, 2], [1, 0, 1, 0], [0, 8, 0, 9], [0, 5, 8, 9], [3, 1, 3, 6], [3, 2, 1, 5], [6, 0, 4, 5], [4, 5, 8, 9], [0, 5, 5, 0], [6, 8, 2, 8], [3, 3, 2, 5], [1, 3, 4, 5], [0, 3, 7, 4], [4, 9, 2, 9], [8, 8, 1, 9], [1, 2, 5, 2], [6, 9, 9, 3], [9, 6, 3, 0], [1, 5, 0, 0], [5, 8, 6, 7], [0, 2, 8, 5]]
]
